...
from AntController.HaikuActorCritic import HaikuActorCritic, EpisodeWithValue
...
if __name__ == "__main__":
    path = "AntController/configs/ant_aac_config_no_sensor_multi_step.yaml"
    with open(path) as file:
        config = yaml.load(file, Loader=yaml.FullLoader)

    rewards_data, frames_data, critic_losses = [], [], []
    env = AntIRLEnvironmentMultiStep(sensors_enabled=False, past_steps=1)
